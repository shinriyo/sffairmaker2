...
def testAllocBgColor():
    ...
    # �s�N�Z���̃`�F�b�N
    # �ϊ��O: 0, 1, 2, 3, 4, 0, 6, 7, 8, 9, 0, 11, 12, 13, 14, 0, 16
    # �ϊ���: 1, 2, 3, 4, 5, 1, 6, 7, 8, 9, 1, 11, 12, 13, 14, 1, 16
    ...
    #�p���b�g�̃`�F�b�N
    # �ϊ��O: #000, #111, ..., #FFF
    # �ϊ���: #123, #000, #111, #222, #333, #444, #666, #777, ..., #FFF, #000, #000, ...
...
def testImmutable():
    # input �� QImage �� output��QImage���ʃI�u�W�F�N�g�ł��邩�̌���
    im = Image256(16, 16)
